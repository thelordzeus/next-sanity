  ...
  return (
    <div className="max-w-5xl mx-auto py-20">
      <h1 className="text-7xl font-extrabold">
        Hello I'm{" "}
        <span className="bg-gradient-to-r from-orange-400 via-red-500 to-puprple-600 bg-clip-text text-transparent">
          Zeus!
        </span>
      </h1>
      ...
      {projects.map((project) => (
        <div key={project._id} className="border border-gray-500 rounded-lg ">
          ...
          <div className="font-extrabold bg-gradient-to-r from-orange-400 via-red-500 to-puprple-600 bg-clip-text text-transparent">
            {project.title}
          </div>
        </div>
      ))}
